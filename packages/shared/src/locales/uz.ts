...
export const PAYROLL_UI = {
  ...
  // Yangi sahifa (qaror 21/09/2026): kassa taqsimoti, xodim varagʻi
  cash_collected: 'Bemorlardan olingan',
  cash_uncollected: 'Olinmagan',
  flow_doctors: 'Shifokorlar',
  ...
  paid_up: 'toʻlangan',
  works_count: (n: number) => `${n} ish`,
  tab_statement: 'Hisob',
  tab_works: 'Ishlar',
  tab_payouts: 'Toʻlovlar',
  line_charges: 'Ish summasi',
  line_lab: 'Texnik narxi',
  line_uncollected: 'Bemorlardan olinmagan',
  line_share: (percent: number) => `Ulush · ${percent} % olingandan`,
  pending_note: (sum: string) => `kutilmoqda ${sum} — bemorlar toʻlaganda shu oyga tushadi`,
  line_salary: 'Oylik',
  line_paid: 'Toʻlab berildi',
  line_remaining: 'Qoldiq',
  collected: 'Olingan',
  uncollected: 'Olinmagan',
  debt_of: (sum: string) => `qarz ${sum}`,
  needs_recalc:
    'Ulush 0 — tashriflar foiz qoʻyilishidan oldin yozilgan. «Qayta hisoblash» ni bosing.',
} as const
...
export const TOAST_TEXT = {
  ...
  // Davolash rejasi (18-boʻlim)
  plan_created: 'Reja tuzildi',
  plan_updated: 'Reja saqlandi',
  plan_sent: 'Reja bemorga yuborildi deb belgilandi',
...
export const PLAN_UI = {
  tab: 'Davolash rejasi',
  hint: 'Bemorga taklif qilinadigan ish: bosqichlar, narxlar va jami',
  add: 'Yangi reja',
  empty: 'Hali reja tuzilmagan',
  back: 'Rejalarga',
  /// Reja xossalari
  form_new: 'Yangi reja',
  form_edit: 'Rejani tahrirlash',
  title: 'Reja nomi',
  title_hint: 'Bir bemorda bir nechta reja boʻlishi mumkin — «Arzon variant», «Implant bilan»',
  doctor: 'Shifokor',
  discount: 'Chegirma',
  discount_percent: 'Foizdan hisoblash',
  valid_until: 'Narx amal qiladi',
  valid_until_hint: 'Boʻsh qoldirilsa — muddatsiz',
  note: 'Izoh',
  /// Bosqich va band
  stage_add: 'Bosqich qoʻshish',
  stage_new: 'Yangi bosqich',
  stage_edit: 'Bosqichni tahrirlash',
  stage_name: 'Bosqich nomi',
  stage_name_hint: 'Masalan: «1-bosqich: davolash» yoki «Protez»',
  stage_total: 'Bosqich jami',
  stage_empty: 'Bu bosqichda hali ish yoʻq',
  stage_delete_title: 'Bosqich oʻchirilsinmi?',
  stage_delete_text: 'Ichidagi barcha ishlar ham oʻchadi',
  item_add: 'Ish qoʻshish',
  item_new: 'Yangi ish',
  item_edit: 'Ishni tahrirlash',
  ...
  items_count: (done: number, all: number) => `${done} / ${all} bajarildi`,
  expired: 'Muddati oʻtgan',
  /// Amallar
  send: 'Bemorga yuborish',
  accept: 'Bemor rozi boʻldi',
  decline: 'Bemor rad etdi',
  cancel_plan: 'Rejani bekor qilish',
  resend: 'Qayta yuborish',
  reason: 'Sababi',
  decline_title: 'Bemor nega rad etdi?',
  cancel_title: 'Reja nega bekor qilinadi?',
  cancel_hint: 'Reja oʻchirilmaydi — yozuv tarixda qoladi',
  /// Ochiq havola
  link: 'Bemorga havola',
