...
/// «Yakunlandi» bu yerda yoʻq — u qilingan ish bilan birga tashrif formasi
/// orqali qoʻyiladi (features/visit-form, 10.6)
export type QueueAction = 'confirm' | 'call' | 'arrived' | 'no_show'
